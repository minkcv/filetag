...
CREATE TABLE `files` (
  ...
  `filepath` varchar(300) NOT NULL UNIQUE,
...
CREATE TABLE `tagmap` (
  ...
  KEY `tagid` (`tagid`),
  CONSTRAINT `tagmap_ibfk_1` FOREIGN KEY (`fileid`) REFERENCES `files` (`id`),
  CONSTRAINT `tagmap_ibfk_2` FOREIGN KEY (`tagid`) REFERENCES `tags` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-03-04 18:41:51
